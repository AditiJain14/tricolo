...
from tricolo.metrics.eval_retrieval import compute_metrics #TODO: change
...
class SimCLR(object):
    ...
    def test(self, log_dir):
        ...
        pr_at_k = compute_metrics(dset, embeddings_dict, model_test_folder, metric, concise=render_dir)
        return pr_at_k
