...
def main():
    ...
    parser.add_argument('--prediction_dir', help='path to checkpoint folder', default='./logs/retrieval/v64i128b128/Nov05_07-16-16-0/validate/nearest_neighbor_renderings/2021-11-13_22-17-35') #logs/retrieval/Nov09_09-10-24_Cfg4_GPU0/test/nearest_neighbor_renderings/2021-11-13_00-43-07') # change
