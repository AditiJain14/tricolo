...
parser.add_argument('--output_folder', type=str, default='/local-scratch/localhome/yuer/Desktop/tmp',
...
for i in range(0, args.views):
    ...
    render_file_path = os.path.join(fp, str(i)) # fp + '_r_{0:03d}'.format(int(i * stepsize))
